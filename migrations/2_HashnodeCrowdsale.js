...
module.exports = function(deployer) {
  ...
  deployer.deploy(HashnodeCrowdsale, 
    ...
    endTime,
    5,  // => Rate per 1 ETH
    "0x1F766dB9226D0f0ab6c0E51BE057C0FA85B1C106",
    ...
    100, // max tokens
    10, // tokens to be distributed for Ecosystem
    10, // tokens to be distributed for Team
    30, // tokens to be distributed for Airdrop
    50, // tokens for Sale
    20, // No of Token to be sale on PreICO
    "VPN Cash Coin", // name of the Token
    "VPN", // Symbol
    18 // decimals
